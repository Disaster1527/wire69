        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
            <h2 className="text-3xl md:text-4xl font-bold max-w-2xl">
              Engineered for safety and longevity with premium-grade copper and advanced insulation.
            </h2>
            <p className="text-foreground max-w-xl">
              Every reel is tested for conductivity, tensile strength, and fire resistance before it reaches your site.
            </p>
          </div>
          <div className="grid gap-6 md:grid-cols-3">
            <article className="group relative overflow-hidden rounded-3xl border border-border/60 bg-background/70 shadow-lg">
              <img
                src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?auto=format&fit=crop&w=900&q=80"
                alt="Technician inspecting copper wire spools in a factory"
                className="h-64 w-full object-cover transition duration-500 group-hover:scale-105"
                loading="lazy"
              />
              <div className="space-y-2 p-6">
                <h3 className="text-xl font-semibold">Precision Winding</h3>
                <p className="text-sm text-foreground">
                  Automated winding lines maintain uniform gauge and eliminate micro-fractures for superior conductivity.
                </p>
              </div>
            </article>
            <article className="group relative overflow-hidden rounded-3xl border border-border/60 bg-background/70 shadow-lg">
              <img
                ...
                alt="Quality engineer performing insulation resistance testing"
                className="h-64 w-full object-cover transition duration-500 group-hover:scale-105"
                loading="lazy"
              />
              <div className="space-y-2 p-6">
                <h3 className="text-xl font-semibold">Layered Protection</h3>
                <p className="text-sm text-foreground">
                  Multi-stage insulation and UV shielding protect against abrasion, moisture, and temperature extremes.
                </p>
              </div>
            </article>
            <article className="group relative overflow-hidden rounded-3xl border border-border/60 bg-background/70 shadow-lg">
              <img
                ...
                alt="Electrician installing shielded cables in an industrial panel"
                className="h-64 w-full object-cover transition duration-500 group-hover:scale-105"
                loading="lazy"
              />
              <div className="space-y-2 p-6">
                <h3 className="text-xl font-semibold">Field-Tested Reliability</h3>
                <p className="text-sm text-foreground">
                  Safety-certified installers rely on our cables for mission-critical panels and long-run infrastructure.
                </p>
              </div>
            </article>
          </div>
